...
class AIQueries:
    MATCH_AND_RATE = """1. Input to AI: “Here is the developer profile above. Below is a job description. Compare the
    job description’s requirements with the developer’s experience. Rate the match on a scale from 0 to 100 and provide
    a concise explanation for why you assigned that score.”
2. Output from AI:
