...
MATCH_AND_RATE_QUERY = """Analyze the developer profile and job description below. Perform the following tasks
...
"🤔 [Category] [Partial Match]"\n  ]\n}\n\nMaintain absolute brevity
- maximum 15 words per bullet. Focus on factual
matches/gaps without commentary."""


def evaluate_job_match(user, job, query=MATCH_AND_RATE_QUERY):
    print(user.work_preferences)
    prompt = (
        f"{query}\n\n"
